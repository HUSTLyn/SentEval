...
def batcher(params, batch):
    ...
    with torch.no_grad():
        outputs = params['model'](input_ids, attention_mask=att_mask,token_type_ids = token_type_ids)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', default='xlnet-base-cased', help='model name or path')
